...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.activity.StatusSaverOfAllAppActivity.extractLinks;
...
public class LikeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(LikeeActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
