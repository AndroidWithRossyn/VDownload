...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.RootDirectoryTwitter;
...
public class TwitterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(TwitterActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
