...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.ROOTDIRECTORYMOJ;
...
public class MojActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MojActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
        createFileFolder();
        initViews();
