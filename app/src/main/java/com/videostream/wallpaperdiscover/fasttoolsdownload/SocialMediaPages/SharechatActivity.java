...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.RootDirectoryShareChat;
...
public class SharechatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(SharechatActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
        commonClassForAPI = CommonClassForAPI.getInstance(activity);
        createFileFolder();
        initViews();

        binding.imAppIcon.setImageDrawable(getResources().getDrawable(R.drawable.shareechat_icon));
