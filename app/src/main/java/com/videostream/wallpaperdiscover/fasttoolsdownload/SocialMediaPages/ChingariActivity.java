...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.ROOTDIRECTORYCHINGARI;
...
public class ChingariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(ChingariActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
