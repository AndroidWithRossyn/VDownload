...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.ROOTDIRECTORYMX;
...
public class MXTakaTakActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MXTakaTakActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
