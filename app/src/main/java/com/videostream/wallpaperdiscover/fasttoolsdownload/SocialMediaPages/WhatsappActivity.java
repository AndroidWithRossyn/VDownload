...
import com.videostream.wallpaperdiscover.fasttoolsdownload.Fragment.WhatsappImageFragment;
import com.videostream.wallpaperdiscover.fasttoolsdownload.Fragment.WhatsappQImageFragment;
import com.videostream.wallpaperdiscover.fasttoolsdownload.Fragment.WhatsappQVideoFragment;
import com.videostream.wallpaperdiscover.fasttoolsdownload.Fragment.WhatsappVideoFragment;
...
import com.videostream.wallpaperdiscover.fasttoolsdownload.databinding.ActivityWhatsappBinding;
import com.videostream.wallpaperdiscover.fasttoolsdownload.databinding.DialogWhatsappPermissionBinding;
...
public class WhatsappActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(WhatsappActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
        createFileFolder();
        initViews();
    ...
    private void initViews() {
        ...
        binding.tvAllowAccess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                InsetDrawable inset = new InsetDrawable(back, 150);
