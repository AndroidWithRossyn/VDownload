...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.RootDirectorySnackVideo;
...
public class SnackVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(SnackVideoActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
