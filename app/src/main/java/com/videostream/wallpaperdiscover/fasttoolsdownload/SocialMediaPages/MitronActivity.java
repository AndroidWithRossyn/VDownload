...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.ROOTDIRECTORYMITRON;
...
public class MitronActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MitronActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
        createFileFolder();
        initViews();
