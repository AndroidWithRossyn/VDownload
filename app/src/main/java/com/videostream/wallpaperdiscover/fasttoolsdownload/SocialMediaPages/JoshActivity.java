...
import static com.videostream.wallpaperdiscover.fasttoolsdownload.utils.Utils.ROOTDIRECTORYJOSH;
...
public class JoshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(JoshActivity.this).showNativeBanner((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], "");
